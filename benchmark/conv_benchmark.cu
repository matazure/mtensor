...
BENCHMARK_TEMPLATE1(BM_cu_conv_block_crack_with_block_tensor, float)->RangeMultiplier(2)->Range(128, 4096)->UseRealTime();
...
BENCHMARK_TEMPLATE1(BM_cu_conv_block_overlap, float)->RangeMultiplier(2)->Range(128, 4096)->UseRealTime();
...
BENCHMARK_TEMPLATE1(BM_cu_conv_block_overlap_with_block_tensor, float)->RangeMultiplier(2)->Range(128, 4096)->UseRealTime();