...
int main() {
	...
	io::read_raw_data("lena_gray8_512x512.raw_data", gray);
	auto cu_gray = mem_clone(gray, device{});
	...
	auto ts_conv = mem_clone(cts_conv, host{});
	io::write_raw_data("lena_gray8_conv_512x512.raw_data", ts_conv);
	...
	cuda::device_synchronize();
	auto ts_byte_conv_block = mem_clone(cts_byte_conv_block, host{});
	io::write_raw_data("lena_gray8_conv_block_512x512.raw_data", ts_byte_conv_block);
	...
	cuda::device_synchronize();
	auto ts_byte_conv_block_crack = mem_clone(cts_byte_conv_block_crack, host{});
	io::write_raw_data("lena_gray8_conv_block_crack_512x512.raw_data", ts_byte_conv_block_crack);
	...
	cuda::device_synchronize();
	auto ts_byte_conv_block_overlap = mem_clone(cts_byte_conv_block_overlap, host{});
	io::write_raw_data("lena_gray8_conv_block_overlap_512x512.raw_data", ts_byte_conv_block_overlap);
