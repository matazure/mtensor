...
int main() {
	...
	auto cu_gray = mem_clone(gray, device_tag{});
	...
	cuda::device_synchronize();
	auto ts_byte_conv_block = mem_clone(cts_byte_conv_block, host_tag{});
	...
	cuda::device_synchronize();
	auto ts_byte_conv_block_crack = mem_clone(cts_byte_conv_block_crack, host_tag{});
	...
	cuda::device_synchronize();
	auto ts_byte_conv_block_overlap = mem_clone(cts_byte_conv_block_overlap, host_tag{});
