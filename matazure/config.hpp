...
//for assert
#define STATIC_ASSERT_DIM_MATCHED(T1, T2) static_assert(T1::dim == T2::dim, "the dim is not matched")

#define STATIC_ASSERT_VALUE_TYPE_MATCHED(T1, T2) static_assert(std::is_same<typename T1::value_type, typename T2::value_type>::value, \
