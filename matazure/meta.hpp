...
constexpr auto name##_c(array<_Values0 ...>, array<_Values1 ...>)->array<_Values0 op _Values1 ...> {	\
	return array<_Values0 op _Values1 ...>{};															\
}																										\
																										\
template <int_t ..._Values, int_t _V>																	\
constexpr auto name##_c(array<_Values ...>, int_t_c<_V>)->array<_Values op _V ...> {					\
	return array<_Values op _V ...>{};																	\
}																										\
																										\
template <int_t _V, int_t ..._Values>																	\
constexpr auto name##_c(int_t_c<_V>, array<_Values ...>)->array<_V op _Values ...> {					\
